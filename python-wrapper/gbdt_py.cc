...
#include "include.python/Predictors/GbdtPredictor.h"

#include "include.python/Trainers/Gbdt/OnlineRegressionTree.h"
...
struct Predictor_wrapper : gezi::Predictor, bp::wrapper< gezi::Predictor > {
    ...
    virtual ::Float default_Margin( ::gezi::Vector & features ){
        return gezi::Predictor::Margin( boost::ref(features) );
    }
    ...
    virtual ::Float Output( ::std::string featureStr ) {
        if( bp::override func_Output = this->get_override( "Output" ) )
            return func_Output( featureStr );
        else{
            return this->gezi::Predictor::Output( featureStr );
        }
    }
    
    ::Float default_Output( ::std::string featureStr ) {
        return gezi::Predictor::Output( featureStr );
    }

    virtual ::Float Predict( ::std::string featureStr ) {
        if( bp::override func_Predict = this->get_override( "Predict" ) )
            return func_Predict( featureStr );
        else{
            return this->gezi::Predictor::Predict( featureStr );
        }
    }
    
    ::Float default_Predict( ::std::string featureStr ) {
        return gezi::Predictor::Predict( featureStr );
    }

    virtual ::Float Predict( ::std::string featureStr, ::Float & output ) {
        if( bp::override func_Predict = this->get_override( "Predict" ) )
            return func_Predict( featureStr, output );
        else{
            return this->gezi::Predictor::Predict( featureStr, output );
        }
    }
    
    ::Float default_Predict( ::std::string featureStr, ::Float & output ) {
        return gezi::Predictor::Predict( featureStr, output );
    }
    ...
    virtual ::std::string ToGainSummary( ::gezi::Vector & features, bool sortByAbsGain=true ) {
        if( bp::override func_ToGainSummary = this->get_override( "ToGainSummary" ) )
            return func_ToGainSummary( boost::ref(features), sortByAbsGain );
        else{
            return this->gezi::Predictor::ToGainSummary( boost::ref(features), sortByAbsGain );
        }
    }
    
    ::std::string default_ToGainSummary( ::gezi::Vector & features, bool sortByAbsGain=true ) {
        return gezi::Predictor::ToGainSummary( boost::ref(features), sortByAbsGain );
    }
...
struct GbdtPredictor_wrapper : gezi::GbdtPredictor, bp::wrapper< gezi::GbdtPredictor > {
    ...
    virtual bool LoadText_( ::std::string file ) {
        if( bp::override func_LoadText_ = this->get_override( "LoadText_" ) )
            ...
            return this->gezi::GbdtPredictor::LoadText_( file );
        }
    }
    
    bool default_LoadText_( ::std::string file ) {
        return gezi::GbdtPredictor::LoadText_( file );
    }
    ...
    virtual ::Float default_Margin( ::gezi::Vector & features ){
        return gezi::GbdtPredictor::Margin( boost::ref(features) );
    }
    ...
    virtual ::std::string ToGainSummary( ::gezi::Vector & features, bool sortByAbsGain=true ) {
        if( bp::override func_ToGainSummary = this->get_override( "ToGainSummary" ) )
            ...
            return this->gezi::GbdtPredictor::ToGainSummary( boost::ref(features), sortByAbsGain );
        }
    }
    
    ::std::string default_ToGainSummary( ::gezi::Vector & features, bool sortByAbsGain=true ) {
        return gezi::GbdtPredictor::ToGainSummary( boost::ref(features), sortByAbsGain );
    }
...
struct GbdtRankingPredictor_wrapper : gezi::GbdtRankingPredictor, bp::wrapper< gezi::GbdtRankingPredictor > {

    GbdtRankingPredictor_wrapper(gezi::GbdtRankingPredictor const & arg )
    : gezi::GbdtRankingPredictor( arg )
      , bp::wrapper< gezi::GbdtRankingPredictor >(){
        // copy constructor
        
    }

    GbdtRankingPredictor_wrapper()
    : gezi::GbdtRankingPredictor()
      , bp::wrapper< gezi::GbdtRankingPredictor >(){
        // null constructor
...
BOOST_PYTHON_MODULE(libgbdt){
    { //::std::vector< std::shared_ptr<gezi::Instance> >
        typedef bp::class_< std::vector< std::shared_ptr<gezi::Instance> > > vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer_t;
        vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer_t vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer = vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer_t( "vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater_" );
        bp::scope vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__scope( vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer );
        //WARNING: the next line of code will not compile, because "::std::shared_ptr<gezi::Instance>" does not have operator== !
        vector_less__std_scope_shared_ptr_less_gezi_scope_Instance_greater___greater__exposer.def( bp::vector_indexing_suite< ::std::vector< std::shared_ptr<gezi::Instance> >, true >() );
    }
    ...
    { //::std::vector< gezi::Vector >
        typedef bp::class_< std::vector< gezi::Vector > > vector_less__gezi_scope_Vector__greater__exposer_t;
        vector_less__gezi_scope_Vector__greater__exposer_t vector_less__gezi_scope_Vector__greater__exposer = vector_less__gezi_scope_Vector__greater__exposer_t( "vector_less__gezi_scope_Vector__greater_" );
        bp::scope vector_less__gezi_scope_Vector__greater__scope( vector_less__gezi_scope_Vector__greater__exposer );
        vector_less__gezi_scope_Vector__greater__exposer.def( bp::vector_indexing_suite< ::std::vector< gezi::Vector > >() );
    }

    { //::std::vector< gezi::OnlineRegressionTree::DebugNode >
        typedef bp::class_< std::vector< gezi::OnlineRegressionTree::DebugNode > > vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer_t;
        vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer_t vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer = vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer_t( "vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater_" );
        bp::scope vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__scope( vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer );
        //WARNING: the next line of code will not compile, because "::gezi::OnlineRegressionTree::DebugNode" does not have operator== !
        vector_less__gezi_scope_OnlineRegressionTree_scope_DebugNode__greater__exposer.def( bp::vector_indexing_suite< ::std::vector< gezi::OnlineRegressionTree::DebugNode > >() );
    }
    ...
    { //::gezi::Predictor
        ...
        { //::gezi::Predictor::BulkPredict
            ...
            typedef ::std::vector< double > ( ::gezi::Predictor::*BulkPredict_function_type)( ::std::vector< std::shared_ptr<gezi::Instance> > & ) ;
        ...
        { //::gezi::Predictor::BulkPredict
            ...
            typedef ::std::vector< double > ( ::gezi::Predictor::*BulkPredict_function_type)( ::std::vector< std::shared_ptr<gezi::Instance> > &,::std::vector< double > & ) ;
            
            Predictor_exposer.def( 
                "BulkPredict"
                , BulkPredict_function_type( &::gezi::Predictor::BulkPredict )
                , ( bp::arg("instances"), bp::arg("outputs") ) );
        ...
        { //::gezi::Predictor::Margin
            ...
            Predictor_exposer.def( 
                "Margin"
                , Margin_function_type( &Predictor_wrapper::default_Margin )
                , ( bp::arg("features") ) );
        ...
        { //::gezi::Predictor::Predict
            ...
            typedef ::Float ( ::gezi::Predictor::*Predict_function_type)( ::std::string ) ;
            typedef ::Float ( Predictor_wrapper::*default_Predict_function_type)( ::std::string ) ;
        ...
        { //::gezi::Predictor::Predict
            ...
            Predictor_exposer.def( 
                ...
                , Predict_function_type(&::gezi::Predictor::Predict)
                , default_Predict_function_type(&Predictor_wrapper::default_Predict)
                , ( bp::arg("featureStr"), bp::arg("output") ) );
        ...
        { //::gezi::Predictor::ToGainSummary
            ...
            typedef ::std::string ( ::gezi::Predictor::*ToGainSummary_function_type)( ::gezi::Vector &,bool ) ;
            typedef ::std::string ( Predictor_wrapper::*default_ToGainSummary_function_type)( ::gezi::Vector &,bool ) ;
            ...
            Predictor_exposer.def( 
                ...
                , ( bp::arg("features"), bp::arg("sortByAbsGain")=(bool)(true) ) );
    ...
    { //::gezi::GbdtPredictor
        ...
        { //::gezi::GbdtPredictor::LoadText_
        
            typedef bool ( ::gezi::GbdtPredictor::*LoadText__function_type)( ::std::string ) ;
            typedef bool ( GbdtPredictor_wrapper::*default_LoadText__function_type)( ::std::string ) ;
            
            GbdtPredictor_exposer.def( 
                "LoadText_"
                , LoadText__function_type(&::gezi::GbdtPredictor::LoadText_)
        ...
        { //::gezi::GbdtPredictor::Margin
            ...
            GbdtPredictor_exposer.def( 
                "Margin"
                , Margin_function_type( &GbdtPredictor_wrapper::default_Margin )
                , ( bp::arg("features") ) );
        ...
        { //::gezi::GbdtPredictor::PrintFeatureGain
        
            typedef void ( ::gezi::GbdtPredictor::*PrintFeatureGain_function_type)( ::gezi::Vector &,bool,int ) ;
            
            GbdtPredictor_exposer.def( 
                "PrintFeatureGain"
                , PrintFeatureGain_function_type( &::gezi::GbdtPredictor::PrintFeatureGain )
                , ( bp::arg("features"), bp::arg("sortByAbsGain")=(bool)(true), bp::arg("level")=(int)(0) ) );
        
        }
        { //::gezi::GbdtPredictor::PrintTreeScores
        
            typedef void ( ::gezi::GbdtPredictor::*PrintTreeScores_function_type)( bool,bool,int ) const;
            
            GbdtPredictor_exposer.def( 
                "PrintTreeScores"
                , PrintTreeScores_function_type( &::gezi::GbdtPredictor::PrintTreeScores )
                , ( bp::arg("sortByScore")=(bool)(false), bp::arg("reverse")=(bool)(true), bp::arg("maxTreeNum")=(int)(-1) ) );
        ...
        { //::gezi::GbdtPredictor::ToGainSummary
            ...
            typedef ::std::string ( ::gezi::GbdtPredictor::*ToGainSummary_function_type)( ::gezi::Vector &,bool ) ;
            typedef ::std::string ( GbdtPredictor_wrapper::*default_ToGainSummary_function_type)( ::gezi::Vector &,bool ) ;
        ...
        GbdtPredictor_exposer.def_readwrite( "_debugNodes", &gezi::GbdtPredictor::_debugNodes );
        ...
        { //::gezi::Predictor::InitThread
            ...
            typedef void ( ::gezi::Predictor::*InitThread_function_type)(  ) ;
            typedef void ( GbdtPredictor_wrapper::*default_InitThread_function_type)(  ) ;
            
            GbdtPredictor_exposer.def( 
                "InitThread"
                , InitThread_function_type(&::gezi::Predictor::InitThread)
                , default_InitThread_function_type(&GbdtPredictor_wrapper::default_InitThread) );
        ...
        { //::gezi::Predictor::Predict
            ...
            typedef ::Float ( ::gezi::Predictor::*Predict_function_type)( ::std::string ) ;
            typedef ::Float ( GbdtPredictor_wrapper::*default_Predict_function_type)( ::std::string ) ;
        ...
        { //::gezi::Predictor::Predict
            ...
            typedef ::Float ( ::gezi::Predictor::*Predict_function_type)( ::Float ) ;
            typedef ::Float ( GbdtPredictor_wrapper::*default_Predict_function_type)( ::Float ) ;
    ...
    bp::class_< GbdtRankingPredictor_wrapper, bp::bases< gezi::GbdtPredictor > >( "GbdtRankingPredictor" )    
        .def( 
            "CustomLoad"
            , (bool ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::CustomLoad)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_CustomLoad)
            , ( bp::arg("path") ) )    
        .def( 
            "CustomLoad_"
            , (bool ( ::gezi::GbdtPredictor::* )( ::std::string ))(&::gezi::GbdtPredictor::CustomLoad_)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_CustomLoad_)
            , ( bp::arg("path") ) )    
        .def( 
            "CustomSave"
            , (void ( ::gezi::Predictor::* )(  ))(&::gezi::Predictor::CustomSave)
            , (void ( GbdtRankingPredictor_wrapper::* )(  ))(&GbdtRankingPredictor_wrapper::default_CustomSave) )    
        .def( 
            "CustomSave"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::CustomSave)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_CustomSave)
            , ( bp::arg("path") ) )    
        .def( 
            "CustomSave_"
            , (void ( ::gezi::GbdtPredictor::* )( ::std::string ))(&::gezi::GbdtPredictor::CustomSave_)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_CustomSave_)
            , ( bp::arg("path") ) )    
        .def( 
            "InitThread"
            , (void ( ::gezi::Predictor::* )(  ))(&::gezi::Predictor::InitThread)
            , (void ( GbdtRankingPredictor_wrapper::* )(  ))(&GbdtRankingPredictor_wrapper::default_InitThread) )    
        .def( 
            "Load"
            , (bool ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Load)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Load)
            , ( bp::arg("path") ) )    
        .def( 
            "LoadBin"
            , (bool ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::LoadBin)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_LoadBin)
            , ( bp::arg("path") ) )    
        .def( 
            "LoadText"
            , (bool ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::LoadText)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_LoadText)
            , ( bp::arg("path") ) )    
        .def( 
            "LoadText_"
            , (bool ( ::gezi::GbdtPredictor::* )( ::std::string ))(&::gezi::GbdtPredictor::LoadText_)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_LoadText_)
            , ( bp::arg("file") ) )    
        .def( 
            "Load_"
            , (bool ( ::gezi::GbdtPredictor::* )( ::std::string ))(&::gezi::GbdtPredictor::Load_)
            , (bool ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Load_)
            , ( bp::arg("file") ) )    
        .def( 
            "Margin"
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::gezi::Vector & ))(&GbdtRankingPredictor_wrapper::default_Margin)
            , ( bp::arg("features") ) )    
        .def( 
            "Output"
        ...
        .def( 
            ...
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::gezi::InstancePtr ))(&GbdtRankingPredictor_wrapper::default_Output)
            , ( bp::arg("instance") ) )    
        .def( 
            "Output"
        ...
        .def( 
            ...
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Output)
            , ( bp::arg("featureStr") ) )    
        .def( 
            "Output"
        ...
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("featureStr") ) )    
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string,::Float & ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::std::string,::Float & ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("featureStr"), bp::arg("output") ) )    
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::gezi::InstancePtr ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::gezi::InstancePtr ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("instance") ) )    
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::gezi::Vector & ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::gezi::Vector & ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("features") ) )    
        .def( 
            "Predict"
        ...
        .def( 
            ...
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::gezi::InstancePtr,::Float & ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("instance"), bp::arg("output") ) )    
        .def( 
            "Predict"
        ...
        .def( 
            ...
            , (::Float ( GbdtRankingPredictor_wrapper::* )( ::Float ))(&GbdtRankingPredictor_wrapper::default_Predict)
            , ( bp::arg("output") ) )    
        .def( 
            "Save"
            , (void ( ::gezi::Predictor::* )(  ))(&::gezi::Predictor::Save)
            , (void ( GbdtRankingPredictor_wrapper::* )(  ))(&GbdtRankingPredictor_wrapper::default_Save) )    
        .def( 
            "Save"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Save)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Save)
            , ( bp::arg("path") ) )    
        .def( 
            "SaveBin"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::SaveBin)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveBin)
            , ( bp::arg("path") ) )    
        .def( 
            "SaveCode"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::SaveCode)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveCode)
            , ( bp::arg("codeTypeStr")="cpp" ) )    
        .def( 
            "SaveCode_"
            , (void ( ::gezi::GbdtPredictor::* )( ::std::string,::gezi::CodeType ))(&::gezi::GbdtPredictor::SaveCode_)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string,::gezi::CodeType ))(&GbdtRankingPredictor_wrapper::default_SaveCode_)
            , ( bp::arg("file"), bp::arg("codeType") ) )    
        .def( 
            "SaveFeaturesGain"
            , (void ( ::gezi::Predictor::* )( int ))(&::gezi::Predictor::SaveFeaturesGain)
            , (void ( GbdtRankingPredictor_wrapper::* )( int ))(&GbdtRankingPredictor_wrapper::default_SaveFeaturesGain)
            , ( bp::arg("topNum")=(int)(0) ) )    
        .def( 
            "SaveJson"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::SaveJson)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveJson)
            , ( bp::arg("file") ) )    
        .def( 
            "SaveJson"
        ...
        .def( 
            ...
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveJson_)
            , ( bp::arg("file") ) )    
        .def( 
            "SaveText"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::SaveText)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveText)
            , ( bp::arg("file") ) )    
        .def( 
            "SaveText"
        ...
        .def( 
            ...
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveText_)
            , ( bp::arg("file") ) )    
        .def( 
            "SaveXml"
            , (void ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::SaveXml)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveXml)
            , ( bp::arg("file") ) )    
        .def( 
            "SaveXml"
        ...
        .def( 
            ...
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_SaveXml_)
            , ( bp::arg("file") ) )    
        .def( 
            "Save_"
            , (void ( ::gezi::GbdtPredictor::* )( ::std::string ))(&::gezi::GbdtPredictor::Save_)
            , (void ( GbdtRankingPredictor_wrapper::* )( ::std::string ))(&GbdtRankingPredictor_wrapper::default_Save_)
            , ( bp::arg("file") ) )    
        .def( 
            "ToFeaturesGainSummary"
            , (::std::string ( ::gezi::Predictor::* )( int ))(&::gezi::Predictor::ToFeaturesGainSummary)
            , (::std::string ( GbdtRankingPredictor_wrapper::* )( int ))(&GbdtRankingPredictor_wrapper::default_ToFeaturesGainSummary)
            , ( bp::arg("topNum")=(int)(0) ) )    
        .def( 
            "ToGainSummary"
            , (::std::string ( ::gezi::GbdtPredictor::* )( ::gezi::Vector &,bool ))(&::gezi::GbdtPredictor::ToGainSummary)
            , (::std::string ( GbdtRankingPredictor_wrapper::* )( ::gezi::Vector &,bool ))(&GbdtRankingPredictor_wrapper::default_ToGainSummary)
            , ( bp::arg("features"), bp::arg("sortByAbsGain")=(bool)(true) ) )    
        .def( 
            "Trees"
            , (::std::vector<gezi::OnlineRegressionTree, std::allocator<gezi::OnlineRegressionTree> > & ( GbdtRankingPredictor_wrapper::* )(  ))(&GbdtRankingPredictor_wrapper::Trees)
                /* undefined call policies */ )    
        .def( 
            "Trees"
            , (::std::vector<gezi::OnlineRegressionTree, std::allocator<gezi::OnlineRegressionTree> > const & ( GbdtRankingPredictor_wrapper::* )(  )const)(&GbdtRankingPredictor_wrapper::Trees)
            , bp::return_value_policy< bp::copy_const_reference >() );
    ...
    bp::class_< GbdtRegressionPredictor_wrapper, bp::bases< gezi::GbdtPredictor > >( "GbdtRegressionPredictor" )    
        ...
        .def( 
            "InitThread"
            , (void ( ::gezi::Predictor::* )(  ))(&::gezi::Predictor::InitThread)
            , (void ( GbdtRegressionPredictor_wrapper::* )(  ))(&GbdtRegressionPredictor_wrapper::default_InitThread) )    
        .def( 
            "Load"
            , (bool ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Load)
        ...
        .def( 
            "Margin"
            , (::Float ( GbdtRegressionPredictor_wrapper::* )( ::gezi::Vector & ))(&GbdtRegressionPredictor_wrapper::default_Margin)
            , ( bp::arg("features") ) )    
        .def( 
            "Output"
            , (::Float ( ::gezi::Predictor::* )( ::gezi::Instance & ))( &::gezi::Predictor::Output )
        ...
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRegressionPredictor_wrapper::* )( ::std::string ))(&GbdtRegressionPredictor_wrapper::default_Predict)
            , ( bp::arg("featureStr") ) )    
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string,::Float & ))(&::gezi::Predictor::Predict)
        ...
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::Float ))(&::gezi::Predictor::Predict)
            , (::Float ( GbdtRegressionPredictor_wrapper::* )( ::Float ))(&GbdtRegressionPredictor_wrapper::default_Predict)
            , ( bp::arg("output") ) )    
        .def( 
            "Save"
            , (void ( ::gezi::Predictor::* )(  ))(&::gezi::Predictor::Save)
        ...
        .def( 
            "ToGainSummary"
            , (::std::string ( ::gezi::GbdtPredictor::* )( ::gezi::Vector &,bool ))(&::gezi::GbdtPredictor::ToGainSummary)
            , (::std::string ( GbdtRegressionPredictor_wrapper::* )( ::gezi::Vector &,bool ))(&GbdtRegressionPredictor_wrapper::default_ToGainSummary)
            , ( bp::arg("features"), bp::arg("sortByAbsGain")=(bool)(true) ) )    
        .def( 
            "Trees"
    ...
    { //::gezi::OnlineRegressionTree
        ...
        bp::class_< gezi::OnlineRegressionTree::DebugNode >( "DebugNode" )    
            .def( bp::self < bp::self )    
            .def_readwrite( "id", &gezi::OnlineRegressionTree::DebugNode::id )    
            .def_readwrite( "paths", &gezi::OnlineRegressionTree::DebugNode::paths )    
            .def_readwrite( "score", &gezi::OnlineRegressionTree::DebugNode::score );
        ...
        OnlineRegressionTree_exposer.def_readwrite( "_debugNode", &gezi::OnlineRegressionTree::_debugNode );
    ...
    bp::class_< ProbabilityPredictor_wrapper, bp::bases< gezi::Predictor > >( "ProbabilityPredictor" )    
        ...
        .def( 
            "Margin"
            , (::Float ( ProbabilityPredictor_wrapper::* )( ::gezi::Vector & ))(&ProbabilityPredictor_wrapper::default_Margin)
            , ( bp::arg("features") ) )    
        .def( 
            "Name"
        ...
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string ))(&::gezi::Predictor::Predict)
            , (::Float ( ProbabilityPredictor_wrapper::* )( ::std::string ))(&ProbabilityPredictor_wrapper::default_Predict)
            , ( bp::arg("featureStr") ) )    
        .def( 
            "Predict"
            , (::Float ( ::gezi::Predictor::* )( ::std::string,::Float & ))(&::gezi::Predictor::Predict)
        ...
        .def( 
            "ToGainSummary"
            , (::std::string ( ::gezi::Predictor::* )( ::gezi::Vector &,bool ))(&::gezi::Predictor::ToGainSummary)
            , (::std::string ( ProbabilityPredictor_wrapper::* )( ::gezi::Vector &,bool ))(&ProbabilityPredictor_wrapper::default_ToGainSummary)
            , ( bp::arg("features"), bp::arg("sortByAbsGain")=(bool)(true) ) );

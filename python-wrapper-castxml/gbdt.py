...
name = 'gbdt'
define_symbols = ['GCCXML','PYTHON_WRAPPER','NO_BAIDU_DEP', '_DEBUG']
#define_symbols = ['GCCXML','PYTHON_WRAPPER']

files = [
                                './gezi.include.python/common_util.h',
																#'./include.python/Trainers/Gbdt/OnlineRegressionTree.h',
																#'./include.python/Prediction/Instances/FeatureNamesVector.h',
																'./include.python/Predictors/GbdtPredictor.h',
																'./include.python/Trainers/Gbdt/OnlineRegressionTree.h', #now can not be before GbdtPredictor, reason unkonwn..
																'./include.python/Prediction/Instances/FeatureNamesVector.h',

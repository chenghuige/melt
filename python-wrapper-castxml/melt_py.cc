...
bp::class_< std::vector< std::shared_ptr<gezi::Predictor> > >("vector_less__std_scope_shared_ptr_less_gezi_scope_Predictor_greater___greater_")
...
.def(
"LoadPredictor"
, (::gezi::PredictorPtr (*)( ::std::string,::std::string,bool,bool ))( &::gezi::PredictorFactory::LoadPredictor )
, ( bp::arg("path"), bp::arg("modelName")="", bp::arg("isText")=(bool)(false), bp::arg("useCustomModel")=(bool)(false) ) )
.def(
"LoadPredictors"
...
.def(
"LoadTextPredictor"
, (::gezi::PredictorPtr (*)( ::std::string,::std::string ))( &::gezi::PredictorFactory::LoadTextPredictor )
, ( bp::arg("path"), bp::arg("modelName")="" ) )
